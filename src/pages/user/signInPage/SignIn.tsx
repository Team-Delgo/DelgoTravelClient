...
function SignIn() {
  ...
  return <div className="login">
    ...
    <button type='button' className='login-button active signup' onClick={()=>{navigation(SIGN_UP_PATH.TERMS)}}>가입하기</button>
    <button type='button' className='login-login' onClick={()=>{navigation(SIGN_IN_PATH.SIGNIN)}}>기존 회원 로그인</button>
  </div>;
}
