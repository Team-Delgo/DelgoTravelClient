...
export const KAKAO = {
  ...
  KAKAO_AUTH_URL: `https://kauth.kakao.com/oauth/authorize?client_id=b40f84b68ce44634317bb5530b0166c1&redirect_uri=https://delgo.pet/oauth/callback/kakao&response_type=code`,
};
